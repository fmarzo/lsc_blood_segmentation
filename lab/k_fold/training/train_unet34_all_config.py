...
brief:  this script trains a U-Net blood segmentation model on all the selected
        grouped configurations generated by create_grouped_split.py.
...
# lab/k_fold/training/train_unet34_all_config.py
...
if len(sys.argv) > 3:
    raise ValueError(
        "Usage: python -m k_fold.training.train_unet34_all_config "
