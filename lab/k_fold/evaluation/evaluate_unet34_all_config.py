"""
file: evaluate_unet34_all_config.py

brief:  this script evaluates the best U-Net ResNet-34 checkpoint associated
    ...
    was previously selected by train_unet34_all_config.py using the lowest
    validation loss.
...
# lab/k_fold/evaluation/evaluate_unet34_all_config.py
...
if len(sys.argv) > 2:
    raise ValueError(
        "Usage: python -m k_fold.evaluation.evaluate_unet34_all_config "
