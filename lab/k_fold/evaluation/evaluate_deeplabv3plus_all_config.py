...
# lab/k_fold/evaluation/evaluate_deeplabv3plus_all_config.py
...
if len(sys.argv) > 2:
    raise ValueError(
        "Usage: python -m k_fold.evaluation.evaluate_deeplabv3plus_all_config "
...
for configuration_directory in configuration_directories:
    ...
    checkpoint_path = (
        checkpoint_directory
        / f"deeplabv3plus_{segmentation_mode}_best_{encoder_name}_config_{configuration_id:03d}.pth"
    )
