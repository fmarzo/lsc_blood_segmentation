"""
file: train_unet18_all_config.py

brief:  this script trains a U-Net blood segmentation model on all the selected
        stratified Rabbani configurations generated by create_stratified_splits.py.
    ...
    For each configuration, a new U-Net model is created from scratch using a
    ResNet-18 encoder pretrained on ImageNet. Both the encoder and decoder
...
# lab/k_fold/rabbani/training/train_unet18_all_config.py
...
if len(sys.argv) > 3:
    raise ValueError(
        "Usage: python -m k_fold.rabbani.training.train_unet18_all_config "
...
for configuration_directory in configuration_directories:
    ...
    adam = torch.optim.Adam(unet.parameters(), lr=learning_rate)
