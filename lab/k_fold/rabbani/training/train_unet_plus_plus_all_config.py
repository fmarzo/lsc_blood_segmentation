"""
file: train_unet_plus_plus_all_config.py

brief:  this script trains a U-Net++ blood segmentation model on all
    ...
    For each configuration, a new U-Net++ model is created from
    ...
    U-Net++ uses nested and dense skip connections between encoder and
    decoder feature maps to progressively refine the segmentation output.
...
# lab/k_fold/rabbani/training/train_unet_plus_plus_all_config.py
...
if len(sys.argv) > 3:
    raise ValueError(
        "Usage: python -m k_fold.rabbani.training.train_unet_plus_plus_all_config "
...
brief:    this routine creates a new U-Net++ ResNet-18 model
"""
def create_model():
...
for configuration_directory in configuration_directories:
    ...
    adam = torch.optim.Adam(unet_plus_plus.parameters(), lr=learning_rate)
    ...
    for epoch in range(n_epochs):
        ...
        for i, (train_img, train_mask) in enumerate(train_rabbani_DL):
            ...
            img_forward = unet_plus_plus(train_img)
        ...
        with torch.no_grad():
            for j, (val_img, val_mask) in enumerate(valid_rabbani_DL):
                ...
                img_forward = unet_plus_plus(val_img)
        ...
        if avg_val_loss < best_val_loss:
            ...
            checkpoint = {
                ...
                "model_state_dict": unet_plus_plus.state_dict(),
