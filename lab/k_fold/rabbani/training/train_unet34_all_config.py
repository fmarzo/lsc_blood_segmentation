"""
file: train_unet34_all_config.py
...
brief:  this script trains a U-Net blood segmentation model on all the selected
    ...
    ResNet-34 encoder pretrained on ImageNet. Both the encoder and decoder
...
# lab/k_fold/rabbani/training/train_unet34_all_config.py
...
if len(sys.argv) > 3:
    raise ValueError(
        "Usage: python -m k_fold.rabbani.training.train_unet34_all_config "
...
brief:    this routine creates a new U-Net ResNet-34 model
"""
def create_model():
    unet = smp.Unet(
